  ...
  },
  {
    ...
    pairs: [
      ...
      },
      {
        ...
        summary:
          "Первая половина — финальная сборка модулей в Drive-папках команд. Вторая половина — защита трёх отобранных жюри команд (SM2, Q2, ZeyinX): короткая презентация по 10 минут, ответы на вопросы жюри и коллег. Остальные модули остаются в архиве саммита и доступны всем участникам.",
        materials: [
