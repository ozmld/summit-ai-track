...
**Иван Эйдлин · 60 минут**

---

За час мы с нуля обучим модель, которая предсказывает: **сдаст ли школьник ОГЭ по математике** — по его оценкам, посещаемости и активности на Учи.ру.
...
6. В конце — **челлендж:** у меня baseline 0.83. Кто побьёт — расскажет как.

Ноутбук идёт вместе с моим рассказом. После каждого блока **пять минут делаем сами** — там где `# TODO`. Кто застрял — поднимает руку, я подхожу.
