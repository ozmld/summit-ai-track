  ...
  return (
    <>
      <PageHeader
        ...
        lead="Вместо защиты-презентации каждый учитель оценивает 3 чужих модуля. Названия команд и участники скрыты — видны только сами материалы. Систему не обмануть: свою команду оценить нельзя."
      />
